    ...
    internal static partial class ExamPdfHtmlBuilder
    {
        ...
        private static string BuildStyles()
        {
            ...
            return string.Concat(
                ...
                ".chip{display:inline-block;text-align:center;font-weight:bold;vertical-align:top;}",
                $".chip.q{{background:#{W.QuestionBadgeFill};color:#{W.QuestionBadgeText};font-size:{PtFromHalfPoints(22)};width:{Pt(W.QuestionBadgeSizeDxa)};height:{Pt(W.QuestionBadgeSizeDxa)};line-height:{Pt(W.QuestionBadgeSizeDxa)};}}",
                $".chip.o{{background:#{W.BadgeGray};font-size:{PtFromHalfPoints(18)};width:{Pt(W.OptionBadgeSizeDxa)};height:{Pt(W.OptionBadgeSizeDxa)};line-height:{Pt(W.OptionBadgeSizeDxa)};}}",
