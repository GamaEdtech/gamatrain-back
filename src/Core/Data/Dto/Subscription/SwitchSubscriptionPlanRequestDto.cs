namespace GamaEdtech.Data.Dto.Subscription
{
    ...
    public sealed class SwitchSubscriptionPlanRequestDto
    {
        ...
        /// *bigger* interval (by resolved price - same immediate/deferred rule as a plan switch, unchanged)
        /// applies immediately; a move to a *smaller* interval is deferred to the current period's end, exactly
        /// like a plan-only downgrade (fixed 2026-08-19 - previously rejected outright with
        /// <c>IntervalDowngradeNotSupported</c>) - see docs/business/subscriptions.md, "Plan upgrade/downgrade
        /// with proration".
        /// </summary>
