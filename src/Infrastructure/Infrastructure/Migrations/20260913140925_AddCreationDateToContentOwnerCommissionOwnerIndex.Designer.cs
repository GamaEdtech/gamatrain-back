...
namespace GamaEdtech.Infrastructure.Migrations
{
    ...
    [Migration("20260913140925_AddCreationDateToContentOwnerCommissionOwnerIndex")]
    partial class AddCreationDateToContentOwnerCommissionOwnerIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamaEdtech.Domain.Entity.ContentOwnerCommission", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("DownloaderUserId")
                        .HasColumnType("bigint")
                        .HasColumnName("DownloaderUserId");

                    b.Property<long>("ExternalContentId")
                        .HasColumnType("bigint")
                        .HasColumnName("ExternalContentId");

                    b.Property<long?>("ExternalExtraId")
                        .HasColumnType("bigint")
                        .HasColumnName("ExternalExtraId");

                    b.Property<string>("ExternalFileType")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar")
                        .HasColumnName("ExternalFileType");
                    ...
                    b.HasIndex("DownloaderUserId");

                    b.HasIndex("OwnerUserId", "CreationDate");
            ...
            modelBuilder.Entity("GamaEdtech.Domain.Entity.Feature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GamaEdtech.Domain.Entity.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("AllNudgesCompletedAt")
                        .HasColumnType("datetimeoffset")
                        .HasColumnName("AllNudgesCompletedAt");
                    ...
                    b.Property<DateTimeOffset?>("NudgesOptedOutAt")
                        .HasColumnType("datetimeoffset")
                        .HasColumnName("NudgesOptedOutAt");
                    ...
                    b.HasIndex("ProfileVisibility", "LastLoginDate")
            ...
            modelBuilder.Entity("GamaEdtech.Domain.Entity.NudgeTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("CtaUrl")
                        ...
                        .HasMaxLength(500)
                        .HasColumnType("varchar")
                        .HasColumnName("CtaUrl");

                    b.Property<bool>("IsActive")
                        .HasColumnType("bit")
                        .HasColumnName("IsActive");

                    b.Property<byte>("NudgeType")
                        .HasColumnType("tinyint")
                    ...
                    b.HasIndex("NudgeType")
                        .IsUnique();

                    b.ToTable("NudgeTemplates");
                });
            ...
            modelBuilder.Entity("GamaEdtech.Domain.Entity.SubscriptionPlanFeature", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("SubscriptionPlanId", "FeatureId", "BillingInterval")
                        .IsUnique();

                    b.ToTable("SubscriptionPlanFeatures");
                });

            modelBuilder.Entity("GamaEdtech.Domain.Entity.SubscriptionPlanGatewayMapping", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("SubscriptionPlanPriceId")
                        .HasColumnType("bigint")
                        .HasColumnName("SubscriptionPlanPriceId");

                    b.HasKey("Id");

                    b.HasIndex("SubscriptionPlanPriceId", "Gateway")
                        .IsUnique();

                    b.ToTable("SubscriptionPlanGatewayMappings");
                });

            modelBuilder.Entity("GamaEdtech.Domain.Entity.SubscriptionPlanPrice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("GamaEdtech.Domain.Entity.UserNudgeLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTimeOffset>("LastSentDate")
                        .HasColumnType("datetimeoffset")
            ...
            modelBuilder.Entity("GamaEdtech.Domain.Entity.UserSubscription", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastPaymentFailedDate")
                        .HasColumnType("datetimeoffset")
                        .HasColumnName("LastPaymentFailedDate");

                    b.Property<byte?>("PendingSwitchBillingInterval")
                        .HasColumnType("tinyint")
                        .HasColumnName("PendingSwitchBillingInterval");
                    ...
                    b.Property<DateTimeOffset?>("SwitchLockedUntil")
                        .HasColumnType("datetimeoffset")
                        .HasColumnName("SwitchLockedUntil");
            ...
            modelBuilder.Entity("GamaEdtech.Domain.Entity.ContentOwnerCommission", b =>
                {
                    b.HasOne("GamaEdtech.Domain.Entity.Identity.ApplicationUser", "Downloader")
                        .WithMany()
                        .HasForeignKey("DownloaderUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("GamaEdtech.Domain.Entity.Identity.ApplicationUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("GamaEdtech.Domain.Entity.SubscriptionPlanGatewayMapping", b =>
                {
                    b.HasOne("GamaEdtech.Domain.Entity.SubscriptionPlanPrice", "SubscriptionPlanPrice")
                        .WithMany()
