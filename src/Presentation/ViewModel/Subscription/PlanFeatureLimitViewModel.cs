namespace GamaEdtech.Presentation.ViewModel.Subscription
{
    ...
    /// <summary>One quota bucket's allowance at one purchased billing interval - e.g. a plan can grant 50 for Monthly and 600 for Yearly of the same feature/group.</summary>
