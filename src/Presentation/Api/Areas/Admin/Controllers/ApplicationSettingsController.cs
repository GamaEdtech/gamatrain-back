            ...
            try
            {
                ...
                return Ok<ApplicationSettingsViewModel>(new(result.Errors)
                {
                    Data = result.Data is null ? null : new()
                    {
                        ...
                        PostCommentConfirmationEmailTemplate = result.Data.PostCommentConfirmationEmailTemplate,
                        ...
                        PostConfirmationEmailTemplate = result.Data.PostConfirmationEmailTemplate,
        ...
        public async Task<IActionResult<bool>> UpdateSettings([NotNull] ApplicationSettingsViewModel request)
        {
            try
            {
                var result = await applicationSettingsService.Value.ModifyApplicationSettingsAsync(new()
                {
                    ...
                    PostCommentConfirmationEmailTemplate = request.PostCommentConfirmationEmailTemplate,
                    ...
                    PostConfirmationEmailTemplate = request.PostConfirmationEmailTemplate,
